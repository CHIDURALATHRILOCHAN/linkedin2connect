...
import { Award, Lock, Mail, User as UserIcon, ArrowRight, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="max-w-md mx-auto py-12 space-y-8">
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-gray-400">Start transforming certificates into high-performing LinkedIn posts.</p>
      </div>
